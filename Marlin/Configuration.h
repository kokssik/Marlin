...
#define STRING_CONFIG_H_AUTHOR "(na3D, C(L) config)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "C(L)"
...
#define HOTEND_OFFSET_X {0.0,    36} // (in mm) for each extruder, offset of the hotend on the X axis
#define HOTEND_OFFSET_Y {0.0,  0.25} // (in mm) for each extruder, offset of the hotend on the Y axis
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4]]]]
 */
#define DEFAULT_MAX_FEEDRATE          { 300, 300, 10, 10 }
 ...
 *    (0,0)
 */
#define X_PROBE_OFFSET_FROM_EXTRUDER  67   // X offset: -left  +right  [of the nozzle]
#define Y_PROBE_OFFSET_FROM_EXTRUDER -29   // Y offset: -front +behind [the nozzle]
#define Z_PROBE_OFFSET_FROM_EXTRUDER  0.83 // Z offset: -below +above  [the nozzle]
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { (X_MIN_POS + 100), (Y_MAX_POS - 200), 200 }
