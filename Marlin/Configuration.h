...
#define HOTEND_OFFSET_X {0.0, 35.0} // (in mm) for each extruder, offset of the hotend on the X axis
 ...
 *    (0,0)
 */
#define X_PROBE_OFFSET_FROM_EXTRUDER 68  // X offset: -left  +right  [of the nozzle]
