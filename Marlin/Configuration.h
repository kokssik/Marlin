...
#define STRING_CONFIG_H_AUTHOR "(JaxTheWolf, Geeetech A10 Pro)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "GTA10 Pro"

// Printer's unique ID, used by some programs to differentiate between machines.
// Choose your own or use a service like https://www.uuidgenerator.net/version4
#define MACHINE_UUID "c057466f-9162-42f9-b2e4-b8e3564e854e"
 ...
 */
  ...
  #define MPC_BLOCK_HEAT_CAPACITY { 12.92f }           // (J/K) Heat block heat capacities.
  #define MPC_SENSOR_RESPONSIVENESS { 0.1419f }        // (K/s per ∆K) Rate of change of sensor temperature from heat block.
  #define MPC_AMBIENT_XFER_COEFF { 0.0825f }           // (W/K) Heat transfer coefficients from heat block to room air with fan off.
  #if ENABLED(MPC_INCLUDE_FAN)
    #define MPC_AMBIENT_XFER_COEFF_FAN255 { 0.1033f }  // (W/K) Heat transfer coefficients from heat block to room air with fan on full.
  #endif
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 108.79 
  #define DEFAULT_bedKi  14.43
  #define DEFAULT_bedKd 546.61
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 79.5, 79.5, 409.92, 96.41 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -35, -25, -2.475 }
...
#define Z_MAX_POS 240 //TODO: re-measure X, Y minpos
//#define I_MIN_POS 0
//#define I_MAX_POS 50
//#define J_MIN_POS 0
//#define J_MAX_POS 50
