...
#define USE_CONTROLLER_FAN
  ...
  #define CONTROLLERFAN_SPEED_MIN       180 // (0-255) Minimum speed. (If set below this value the fan is turned off.)
...
#define FAST_PWM_FAN    // Increase the fan PWM frequency. Removes the PWM noise but increases heating in the FET/Arduino
  ...
  #define FAST_PWM_FAN_FREQUENCY 100U  // Define here to override the defaults below
...
// LCD Print Progress options, multiple can be rotated depending on screen layout
   ...
   */
  //#define SD_SPI_SPEED SPI_SPEED_5
